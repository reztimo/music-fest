                    ...
                    <div className='md:mx-auto md:w-full md:max-w-full py-5'>
                        <section>
                            ...
                            <form className='space-y-6'>
                                ...
                                <div>
                                    <button disabled={!validName || !validPwd || !validMatch ? true : false} type="submit" className='flex w-full justify-center rounded-md text-gray-800 bg-white px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>Register</button>
                                </div>
                                <div>
                                    <Link to="/login">
